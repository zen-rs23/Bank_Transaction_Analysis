...
define(
    'vs/editor/editor.main.nls', {
      ...
      'vs/base/browser/ui/inputbox/inputBox':
          ['Error: {0}', 'Warning: {0}', 'Info: {0}', 'for history'],
      ...
      'vs/base/browser/ui/tree/abstractTree': [
        'Filter', 'Fuzzy Match', 'Type to filter', 'Type to search',
        'Type to search', 'Close', 'No elements found.'
      ],
      'vs/base/common/actions': ['(empty)'],
      'vs/base/common/errorMessage': [
        '{0}: {1}', 'A system error occurred ({0})',
      ...
      'vs/base/common/keybindingLabels': [
        'Ctrl',  'Shift',   'Alt',     'Windows', 'Ctrl',    'Shift',   'Alt',
        'Super', 'Control', 'Shift',   'Option',  'Command', 'Control', 'Shift',
        'Alt',   'Windows', 'Control', 'Shift',   'Alt',     'Super'
      ],
      ...
      'vs/editor/browser/widget/diffReview': [
        ...
        'Icon for \'Close\' in diff review.', 'Close', 'no lines changed',
        '1 line changed', '{0} lines changed',
        'Difference {0} of {1}: original line {2}, {3}, modified line {4}, {5}',
        'blank', '{0} unchanged line {1}',
        '{0} original line {1} modified line {2}', '+ {0} modified line {1}',
        '- {0} original line {1}', 'Go to Next Difference',
        'Go to Previous Difference'
      ],
      'vs/editor/browser/widget/inlineDiffMargin': [
        'Copy deleted lines', 'Copy deleted line', 'Copy changed lines',
        'Copy changed line', 'Copy deleted line ({0})',
        'Copy changed line ({0})', 'Revert this change',
        'Copy deleted line ({0})', 'Copy changed line ({0})'
      ],
 ...
 - Values greater than or equal to 8 will be used as effective values.`,
      ...
      'vs/editor/contrib/anchorSelect/browser/anchorSelect': [
        'Selection Anchor', 'Anchor set at {0}:{1}', 'Set Selection Anchor',
        'Go to Selection Anchor', 'Select from Anchor to Cursor',
        'Cancel Selection Anchor'
      ],
      'vs/editor/contrib/bracketMatching/browser/bracketMatching': [
        'Overview ruler marker color for matching brackets.', 'Go to Bracket',
        'Select to Bracket', 'Remove Brackets', 'Go to &&Bracket'
      ],
      'vs/editor/contrib/caretOperations/browser/caretOperations':
          ['Move Selected Text Left', 'Move Selected Text Right'],
      'vs/editor/contrib/caretOperations/browser/transpose':
          ['Transpose Letters'],
      'vs/editor/contrib/clipboard/browser/clipboard': [
        'Cu&&t', 'Cut', 'Cut', 'Cut', '&&Copy', 'Copy', 'Copy', 'Copy',
        'Copy As', 'Copy As', 'Share', 'Share', 'Share', '&&Paste', 'Paste',
        'Paste', 'Paste', 'Copy With Syntax Highlighting'
      ],
      ...
      'vs/editor/contrib/codeAction/browser/codeActionMenu': [
        'More Actions...', 'Quick Fix...', 'Extract...', 'Inline...',
        'Rewrite...', 'Move...', 'Surround With...', 'Source Action...'
      ],
      ...
      'vs/editor/contrib/codeAction/browser/lightBulbWidget': [
        ...
        'Show Code Actions ({0})', 'Show Code Actions'
      ],
      ...
      'vs/editor/contrib/comment/browser/comment': [
        'Toggle Line Comment', '&&Toggle Line Comment', 'Add Line Comment',
        'Remove Line Comment', 'Toggle Block Comment', 'Toggle &&Block Comment'
      ],
      'vs/editor/contrib/contextmenu/browser/contextmenu': [
        'Minimap', 'Render Characters', 'Vertical size', 'Proportional', 'Fill',
        'Fit', 'Slider', 'Mouse Over', 'Always', 'Show Editor Context Menu'
      ],
      ...
      'vs/editor/contrib/find/browser/findController': [
        'Find', '&&Find', `Overrides "Use Regular Expression" flag.
...
1: True
2: False`,
        'Find With Arguments', 'Find With Selection', 'Find Next',
        'Find Previous', 'Go to Match...',
        'Type a number to go to a specific match (between 1 and {0})',
        'Please type a number between 1 and {0}',
        'Please type a number between 1 and {0}', 'Find Next Selection',
        'Find Previous Selection', 'Replace', '&&Replace'
      ],
      ...
      'vs/editor/contrib/folding/browser/folding': [
        'Unfold', 'Unfold Recursively', 'Fold', 'Toggle Fold',
        'Fold Recursively', 'Fold All Block Comments', 'Fold All Regions',
        'Unfold All Regions', 'Fold All Regions Except Selected',
        'Unfold All Regions Except Selected', 'Fold All', 'Unfold All',
        'Go to Parent Fold', 'Go to Previous Folding Range',
        'Go to Next Folding Range', 'Create Folding Range from Selection',
        'Remove Manual Folding Ranges', 'Fold Level {0}'
      ],
      ...
      'vs/editor/contrib/fontZoom/browser/fontZoom': [
        'Editor Font Zoom In', 'Editor Font Zoom Out', 'Editor Font Zoom Reset'
      ],
      ...
      'vs/editor/contrib/gotoError/browser/gotoError': [
        ...
        'Go to Next Problem in Files (Error, Warning, Info)', 'Next &&Problem',
        'Go to Previous Problem in Files (Error, Warning, Info)',
        'Previous &&Problem'
      ],
      'vs/editor/contrib/gotoError/browser/gotoErrorWidget': [
        'Error', 'Warning', 'Info', 'Hint', '{0} at {1}. ',
        '{0} of {1} problems', '{0} of {1} problem',
      ...
      'vs/editor/contrib/gotoSymbol/browser/peek/referencesTree':
          ['{0} references', '{0} reference', 'References'],
      'vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget':
          ['no preview available', 'No results', 'References'],
      'vs/editor/contrib/gotoSymbol/browser/referencesModel': [
        'symbol in {0} on line {1} at column {2}',
        'symbol in {0} on line {1} at column {2}, {3}',
        '1 symbol in {0}, full path {1}', '{0} symbols in {1}, full path {2}',
        'No results found', 'Found 1 symbol in {0}', 'Found {0} symbols in {1}',
      ...
      'vs/editor/contrib/gotoSymbol/browser/symbolNavigation': [
        ...
        'Symbol {0} of {1}, {2} for next', 'Symbol {0} of {1}'
      ],
      'vs/editor/contrib/hover/browser/hover': [
        'Show or Focus Hover', 'Show Definition Preview Hover',
        'Scroll Up Hover', 'Scroll Down Hover', 'Scroll Left Hover',
        'Scroll Right Hover', 'Page Up Hover', 'Page Down Hover',
        'Go To Top Hover', 'Go To Bottom Hover', 'Escape Focus Hover'
      ],
      ...
      'vs/editor/contrib/hover/browser/markerHoverParticipant': [
        ...
        'Checking for quick fixes...', 'No quick fixes available',
        'Quick Fix...'
      ],
      'vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace':
          ['Replace with Previous Value', 'Replace with Next Value'],
      'vs/editor/contrib/indentation/browser/indentation': [
        'Convert Indentation to Spaces', 'Convert Indentation to Tabs',
        'Configured Tab Size', 'Default Tab Size', 'Current Tab Size',
        'Select Tab Size for Current File', 'Indent Using Tabs',
        'Indent Using Spaces', 'Change Tab Display Size',
        'Detect Indentation from Content', 'Reindent Lines',
        'Reindent Selected Lines'
      ],
      'vs/editor/contrib/inlayHints/browser/inlayHintsHover': [
        'Double-click to insert', 'cmd + click', 'ctrl + click',
        'option + click', 'alt + click',
        'Go to Definition ({0}), right click for more',
        'Go to Definition ({0})', 'Execute Command'
      ],
      'vs/editor/contrib/inlineCompletions/browser/ghostTextController': [
        ...
        'Show Next Inline Suggestion', 'Show Previous Inline Suggestion',
        'Trigger Inline Suggestion', 'Accept Next Word Of Inline Suggestion',
        'Accept Word', 'Accept Inline Suggestion', 'Accept',
        'Hide Inline Suggestion', 'Always Show Toolbar', 'Undo Accept Word',
        'Undo Accept Word'
      ],
      ...
      'vs/editor/contrib/inlineCompletions/browser/inlineSuggestionHintsWidget':
          [
            ...
            'Icon for show previous parameter hint.', '{0} ({1})', 'Previous',
            'Next'
          ],
      ...
      'vs/editor/contrib/links/browser/links': [
        ...
        'Execute command', 'Follow link', 'cmd + click', 'ctrl + click',
        'option + click', 'alt + click', 'Execute command {0}', 'Open Link'
      ],
      ...
      'vs/editor/contrib/parameterHints/browser/parameterHintsWidget': [
        'Icon for show next parameter hint.',
        'Icon for show previous parameter hint.', '{0}, hint',
        'Foreground color of the active item in the parameter hint.'
      ],
      'vs/editor/contrib/peekView/browser/peekView': [
        'Whether the current code editor is embedded inside peek', 'Close',
        'Background color of the peek view title area.',
        'Color of the peek view title.', 'Color of the peek view title info.',
      ...
      'vs/editor/contrib/quickAccess/browser/gotoLineQuickAccess': [
        ...
        'Go to line {0} and character {1}.', 'Go to line {0}.',
      ...
      'vs/editor/contrib/readOnlyMessage/browser/contribution':
          ['Cannot edit in read-only input', 'Cannot edit in read-only editor'],
      'vs/editor/contrib/rename/browser/rename': [
        ...
        'Rename failed to apply edits', 'Rename failed to compute edits',
        'Rename Symbol',
      ...
      'vs/editor/contrib/smartSelect/browser/smartSelect': [
        'Expand Selection', '&&Expand Selection', 'Shrink Selection',
        '&&Shrink Selection'
      ],
      ...
      'vs/editor/contrib/snippet/browser/snippetVariables': [
        ...
        'Saturday', 'Sun',      'Mon',     'Tue',       'Wed',       'Thu',
        'Fri',      'Sat',      'January', 'February',  'March',     'April',
      ...
      'vs/editor/contrib/stickyScroll/browser/stickyScrollActions': [
        'Toggle Sticky Scroll', '&&Toggle Sticky Scroll', 'Sticky Scroll',
        '&&Sticky Scroll', 'Focus Sticky Scroll', '&&Focus Sticky Scroll',
        'Select next sticky scroll line', 'Select previous sticky scroll line',
        'Go to focused sticky scroll line', 'Select Editor'
      ],
      ...
      'vs/editor/contrib/suggest/browser/suggestController': [
        'Accepting \'{0}\' made {1} additional edits', 'Trigger Suggest',
        'Insert', 'Insert', 'Replace', 'Replace', 'Insert', 'show less',
        'show more', 'Reset Suggest Widget Size'
      ],
      'vs/editor/contrib/suggest/browser/suggestWidget': [
        ...
        'Foreground color of the suggest widget status.', 'Loading...',
        'No suggestions.', 'Suggest', '{0}{1}, {2}', '{0}{1}', '{0}, {1}',
        '{0}, docs: {1}'
      ],
      'vs/editor/contrib/suggest/browser/suggestWidgetDetails':
          ['Close', 'Loading...'],
      'vs/editor/contrib/suggest/browser/suggestWidgetRenderer':
          ['Icon for more information in the suggest widget.', 'Read More'],
      ...
      'vs/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators': [
        'Unusual Line Terminators', 'Detected unusual line terminators',
        ...
        '&&Remove Unusual Line Terminators', 'Ignore'
      ],
      ...
      'vs/editor/contrib/wordHighlighter/browser/wordHighlighter': [
        'Go to Next Symbol Highlight', 'Go to Previous Symbol Highlight',
        'Trigger Symbol Highlight'
      ],
      'vs/editor/contrib/wordOperations/browser/wordOperations':
          ['Delete Word'],
      'vs/platform/action/common/actionCommonCategories':
          ['View', 'Help', 'Test', 'File', 'Preferences', 'Developer'],
      'vs/platform/actionWidget/browser/actionList': [
        '{0} to apply, {1} to preview', '{0} to apply',
        '{0}, Disabled Reason: {1}', 'Action Widget'
      ],
      'vs/platform/actionWidget/browser/actionWidget': [
        'Whether the action widget list is visible', 'Hide action widget',
        'Select previous action', 'Select next action',
        'Accept selected action', 'Preview selected action'
      ],
...
[{1}] {2}`
      ...
      'vs/platform/audioCues/browser/audioCueService': [
        'Error on Line', 'Warning on Line', 'Folded Area on Line',
        'Breakpoint on Line', 'Inline Suggestion on Line', 'Terminal Quick Fix',
        'Debugger Stopped on Breakpoint', 'No Inlay Hints on Line',
        'Task Completed', 'Task Failed', 'Terminal Command Failed',
        'Terminal Bell', 'Notebook Cell Completed', 'Notebook Cell Failed',
        'Diff Line Inserted', 'Diff Line Deleted', 'Diff Line Modified'
      ],
      ...
      'vs/platform/contextkey/common/contextkey': [
        ...
        '\'in\' after \'not\'.', 'closing parenthesis \')\'',
        'Unexpected token', 'Did you forget to put && or || before the token?',
        'Unexpected end of expression', 'Did you forget to put a context key?',
        `Expected: {0}
Received: '{1}'.`
      ],
      ...
      'vs/platform/contextkey/common/scanner': [
        'Did you mean {0}?', 'Did you mean {0} or {1}?',
      ...
      'vs/platform/quickinput/browser/commandsQuickAccess': [
        '{0}, {1}', 'recently used', 'commonly used', 'other commands',
        'Command \'{0}\' resulted in an error'
      ],
      'vs/platform/quickinput/browser/helpQuickAccess': ['{0}, {1}'],
      'vs/platform/quickinput/browser/quickInput': [
        'Back', 'Press \'Enter\' to confirm your input or \'Escape\' to cancel',
        '{0}/{1}', 'Type to narrow down results.', 'Toggle all checkboxes',
        '{0} Results', '{0} Selected', 'OK', 'Custom', 'Back ({0})', 'Back'
      ],
