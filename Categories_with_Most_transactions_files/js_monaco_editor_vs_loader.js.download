'use strict'; /*!-----------------------------------------------------------
               * @license Copyright (c) Microsoft Corporation. All rights
               *reserved. Version:
               *0.37.1(20a8d5a651d057aaed7875ad1c1f2ecf13c4e773) Released under
               *the MIT license
...
class y {
  ...
  constructor() {
    this._detected = !1, this._isWindows = !1, this._isNode = !1,
    this._isElectronRenderer = !1, this._isWebWorker = !1,
    this._isElectronNodeIntegrationWebWorker = !1
  }
  _detect() {
    this._detected ||
        (this._detected = !0, this._isWindows = y._isWindows(),
         this._isNode = typeof module < 'u' && !!module.exports,
         this._isElectronRenderer = typeof process < 'u' &&
         ...
         this._isElectronNodeIntegrationWebWorker = this._isWebWorker &&
             typeof process < 'u' && typeof process.versions < 'u' &&
             typeof process.versions.electron < 'u' &&
             process.type === 'worker')
  }
  static _isWindows() {
...
class y {
  ...
  static isEmpty(p) {
    let h = !0;
    return y.forEachProperty(p, () => {h = !1}), h
  }
  static recursiveClone(p) {
    if (!p || typeof p != 'object' || p instanceof RegExp ||
        !Array.isArray(p) && Object.getPrototypeOf(p) !== Object.prototype)
      return p;
    let h = Array.isArray(p) ? [] : {};
    return y.forEachProperty(
               p,
               (r, c) => {
                   c && typeof c == 'object' ? h[r] = y.recursiveClone(c) :
                                               h[r] = c}),
           h
  }
  ...
  static getHighPerformanceTimestamp() {
    return this.PERFORMANCE_NOW_PROBED ||
               (this.PERFORMANCE_NOW_PROBED = !0,
                this.HAS_PERFORMANCE_NOW = u.global.performance &&
                    typeof u.global.performance.now == 'function'),
           this.HAS_PERFORMANCE_NOW ? u.global.performance.now() : Date.now()
  }
}
y.NEXT_ANONYMOUS_ID = 1, y.PERFORMANCE_NOW_PROBED = !1,
                         y.HAS_PERFORMANCE_NOW = !1, u.Utilities = y
})(AMDLoader || (AMDLoader = {}));
var AMDLoader;
(function(u) {
function y(h) {
...
class m {
  static validateConfigurationOptions(r) {
    function c(a) {
      if (a.phase === 'loading') {
        console.error('Loading "' + a.moduleId + '" failed'), console.error(a),
      ...
      if (a.phase === 'factory') {
        console.error(
            'The factory function of "' + a.moduleId +
    ...
    if (r = r || {}, typeof r.baseUrl != 'string' && (r.baseUrl = ''),
        ...
        r.nodeCachedData && typeof r.nodeCachedData == 'object' &&
            (typeof r.nodeCachedData.seed != 'string' &&
             ...
             !r.nodeCachedData.path ||
                 typeof r.nodeCachedData.path != 'string')) {
      const a = y(
...
class p {
  constructor(r, c) {
    if (this._env = r, this.options = m.mergeConfigurationOptions(c),
        this._createIgnoreDuplicateModulesMap(), this._createSortedPathsRules(),
        this.options.baseUrl === '' && this.options.nodeRequire &&
  ...
  _createSortedPathsRules() {
    ...
    u.Utilities.forEachProperty(
        this.options.paths,
        (r, c) => {
            Array.isArray(c) ? this.sortedPathsRules.push({from: r, to: c}) :
  ...
  _addUrlArgsToUrl(r) {
    return u.Utilities.containsQueryString(r) ? r + '&' + this.options.urlArgs :
  ...
  moduleIdToPaths(r) {
    if (this._env.isNode && this.options.amdModulesPattern instanceof RegExp &&
    ...
    if (!u.Utilities.endsWith(c, '.js') && !u.Utilities.isAbsolutePath(c)) {
      ...
      !u.Utilities.endsWith(c, '.js') && !u.Utilities.containsQueryString(c) &&
          (c = c + '.js'),
          a = [c];
  ...
  requireToUrl(r) {
    let c = r;
    return u.Utilities.isAbsolutePath(c) ||
               (c = this._applyPaths(c)[0],
                u.Utilities.isAbsolutePath(c) ||
                    (c = this.options.baseUrl + c)),
  ...
  shouldInvokeFactory(r) {
    return !!(
        !this.options.isBuild || u.Utilities.isAnonymousModule(r) ||
  ...
  load(e, i, s, n) {
    if (!this._scriptLoader)
      if (this._env.isWebWorker)
        ...
        this._env.isNode ? this._scriptLoader = new r(this._env) :
    ...
    this._scriptLoader.load(
        e, i, () => this.triggerCallback(i), d => this.triggerErrorback(i, d))
  }
  triggerCallback(e) {
...
function p(t) {
  ...
  try {
    return (e ? self.eval(e.createScript('', 'true')) : new Function('true'))
               .call(self),
           !0
  } catch {
    return !1
...
class h {
  ...
  _canUseEval(e) {
    return this._cachedCanUseEval === null && (this._cachedCanUseEval = p(e)),
      ...
      if (!(/^((http:)|(https:)|(file:))/.test(i) &&
        ...
        fetch(i)
            ...
            .then(o => {
              o = `${o}
//# sourceURL=${i}`,
              (l ? self.eval(l.createScript('', o)) : new Function(o))
                  .call(self),
              s()
            })
            .then(void 0, n);
...
class r {
  ...
  _init(e) {
    this._didInitialize ||
        (this._didInitialize = !0, this._fs = e('fs'), this._vm = e('vm'),
    ...
    function d(o) {
      ...
      return f.resolve =
        ...
        return _._resolveFilename(v, o, !1, E)
             ...
             f.main = process.mainModule, f.extensions = _._extensions,
             f.cache = _._cache, f
    }
    l.prototype._compile = function(o, _) {
      const f = l.wrap(o.replace(/^#!.*/, '')), g = i.getRecorder(),
            v = n._getCachedDataPath(s, _), E = {filename: _};
      let I;
      try {
      ...
      const C = new n._vm.Script(f, E), P = C.runInThisContext(E),
            w = n._path.dirname(_), R = d(this),
            U = [this.exports, R, this, _, w, process, _commonjsGlobal, Buffer],
            b = P.apply(this.exports, U);
      return n._handleCachedData(C, f, v, !E.cachedData, i),
             n._verifyCachedData(C, f, v, I, i), b
    }
  }
  load(e, i, s, n) {
    const l = e.getConfig().getOptionsLiteral(),
  ...
  _createAndEvalScript(e, i, s, n, l) {
    ...
    const o = new this._vm.Script(i, s), _ = o.runInThisContext(s),
    ...
    return v.amd = f.amd,
           _.call(
               u.global, e.getGlobalAMDRequireFunc(), v, s.filename,
               this._path.dirname(s.filename)),
           d.record(32, s.filename),
           g ? n() :
               l(new Error(`Didn't receive define call in ${s.filename}!`)),
           o
  }
  ...
  _getCachedDataPath(e, i) {
    const s = this._crypto.createHash('md5')
                  .update(i, 'utf8')
                  .update(e.seed, 'utf8')
                  .update(process.arch, '')
                  .digest('hex'),
  ...
  _readSourceAndCachedData(e, i, s, n) {
    if (!i)
      this._fs.readFile(e, {encoding: 'utf8'}, n);
    else {
      let l, d, o, _ = 2;
      const f = g => {
        g ? n(g) : --_ === 0 && n(void 0, l, d, o)
      };
      this._fs.readFile(e, {encoding: 'utf8'}, (g, v) => {l = v, f(g)}),
  ...
  _verifyCachedData(e, i, s, n, l) {
    n && (e.cachedDataRejected || setTimeout(() => {
            ...
            n.equals(d) ||
                (l.getConfig().onError(
                     new Error(`FAILED TO VERIFY CACHED DATA, deleting stale '${
                         s}' now, but a RESTART IS REQUIRED`)),
                 this._fs.unlink(s, o => {o && l.getConfig().onError(o)}))
...
class y {
  constructor(t) {
    let e = t.lastIndexOf('/');
    e !== -1 ? this.fromModulePath = t.substr(0, e + 1) :
               this.fromModulePath = ''
  }
  ...
  resolveModule(t) {
    let e = t;
    return u.Utilities.isAbsolutePath(e) ||
...
class m {
  constructor(t, e, i, s, n, l) {
    this.id = t, this.strId = e, this.dependencies = i, this._callback = s,
    this._errorback = n, this.moduleIdResolver = l, this.exports = {},
    this.error = null, this.exportsPassedIn = !1,
  ...
  static _safeInvokeFunction(t, e) {
    try {
      return {
        returnedValue: t.apply(u.global, e), producedError: null
      }
    } catch (i) {
      return {
        returnedValue: null, producedError: i
      }
    }
  }
  ...
  complete(t, e, i, s) {
    ...
    if (this._callback)
      if (typeof this._callback == 'function') {
        ...
        n = l.producedError, t.record(22, this.strId),
        !n && typeof l.returnedValue < 'u' &&
    ...
    if (n) {
      ...
      l.phase = 'factory', l.moduleId = this.strId, l.neededBy = s(this.id),
      this.error = l, e.onError(l)
    }
    this.dependencies = null, this._callback = null, this._errorback = null,
    this.moduleIdResolver = null
  }
  onDependencyError(t) {
    return this._isComplete = !0, this.error = t,
...
class p {
  constructor() {
    this._nextId = 0, this._strModuleIdToIntModuleId = new Map,
    this._intModuleIdToStrModuleId = [], this.getModuleId('exports'),
    this.getModuleId('module'), this.getModuleId('require')
  }
  getMaxModuleId() {
    return this._nextId
  }
  getModuleId(t) {
    ...
    return typeof e > 'u' &&
               (e = this._nextId++, this._strModuleIdToIntModuleId.set(t, e),
...
h.EXPORTS = new h(0), h.MODULE = new h(1), h.REQUIRE = new h(2),
...
class c {
  constructor(t, e, i, s, n = 0) {
    this._env = t, this._scriptLoader = e, this._loaderAvailableTimestamp = n,
    this._defineFunc = i, this._requireFunc = s, this._moduleIdProvider = new p,
    this._config = new u.Configuration(this._env),
    this._hasDependencyCycle = !1, this._modules2 = [],
    this._knownModules2 = [], this._inverseDependencies2 = [],
    this._inversePluginDependencies2 = new Map,
    this._currentAnonymousDefineCall = null, this._recorder = null,
    this._buildInfoPath = [], this._buildInfoDefineStack = [],
    this._buildInfoDependencies = []
  }
  reset() {
    return new c(
        this._env, this._scriptLoader, this._defineFunc, this._requireFunc,
  ...
  defineModule(t, e, i, s, n, l = new y(t)) {
    ...
    this._config.isBuild() &&
        (this._buildInfoDefineStack[d] = n,
         this._buildInfoDependencies[d] =
             (o.dependencies ||
              []).map(_ => this._moduleIdProvider.getStrModuleId(_.id))),
    this._resolve(o)
  }
  ...
  synchronousRequire(t, e = new y(t)) {
    ...
    if (!s)
      throw new Error(
          ...
          t + '\'. This is the first mention of this module!');
    if (!s.isComplete())
      throw new Error(
          'Check dependency list! Synchronous require cannot resolve module \'' +
          t + '\'. This module has not been resolved completely yet.');
    if (s.error) throw s.error;
    return s.exports
  }
  configure(t, e) {
    let i = this._config.shouldRecordStats();
    e ? this._config = new u.Configuration(this._env, t) :
  ...
  _onLoad(t) {
    if (this._currentAnonymousDefineCall !== null) {
      ...
      this.defineModule(
          this._moduleIdProvider.getStrModuleId(t), e.dependencies, e.callback,
          null, e.stack)
    }
  }
  _createLoadError(t, e) {
    let i = this._moduleIdProvider.getStrModuleId(t),
        s = (this._inverseDependencies2[t] ||
             []).map(l => this._moduleIdProvider.getStrModuleId(l));
  ...
  _onLoadError(t, e) {
    ...
    this._modules2[t] ||
        (this._modules2[t] = new m(
             t, this._moduleIdProvider.getStrModuleId(t), [], () => {}, null,
             null));
    let s = [];
  ...
  _createRequire(t) {
    ...
    return e.toUrl = i => this._config.requireToUrl(t.resolveModule(i)),
  ...
  _loadModule(t) {
    ...
    let e = this._moduleIdProvider.getStrModuleId(t),
        i = this._config.moduleIdToPaths(e), s = /^@[^\/]+\/[^\/]+$/;
    this._env.isNode && (e.indexOf('/') === -1 || s.test(e)) &&
        i.push('node|' + e);
    let n = -1, l = d => {
      if (n++, n >= i.length)
        this._onLoadError(t, d);
      else {
        let o = i[n], _ = this.getRecorder();
        if (this._config.isBuild() && o === 'empty:') {
          this._buildInfoPath[t] = o,
          this.defineModule(
              this._moduleIdProvider.getStrModuleId(t), [], null, null, null),
          this._onLoad(t);
          return
        }
        _.record(10, o),
  ...
  _loadPluginDependency(t, e) {
    ...
    let i = s => {
      this.defineModule(
          this._moduleIdProvider.getStrModuleId(e.id), [], s, null, null)
    };
    i.error =
        s => {
    ...
    t.load(
        e.pluginParam, this._createRequire(y.ROOT), i,
      ...
      for (let i = 0, s = e.length; i < s; i++) {
        ...
        if (this._hasDependencyPath(n.id, t.id)) {
          ...
          console.warn(
              ...
              this._moduleIdProvider.getStrModuleId(n.id) + '\' and \'' +
              this._moduleIdProvider.getStrModuleId(t.id) +
              '\'. The cyclic path follows:');
          let d = this._findCyclePath(n.id, t.id, 0) || [];
          d.reverse(), d.push(n.id),
              console.warn(d.map(o => this._moduleIdProvider.getStrModuleId(o))
                               .join(` => 
`)),
              t.unresolvedDependenciesCount--;
          continue
        }
        if (this._inverseDependencies2[n.id] =
                this._inverseDependencies2[n.id] || [],
            this._inverseDependencies2[n.id].push(t.id), n instanceof r) {
          ...
          o || (o = [], this._inversePluginDependencies2.set(n.pluginId, o)),
              o.push(n), this._loadModule(n.pluginId);
          continue
        }
  ...
  _onModuleComplete(t) {
    ...
    const n = o => (this._inverseDependencies2[o] ||
                    []).map(_ => this._moduleIdProvider.getStrModuleId(_));
...
const p = function(a, t, e) {
  typeof a != 'string' && (e = t, t = a, a = null),
      ...
      a ? m.defineModule(a, t, e, null, null) :
...
const h = function(a, t = !1) {
  ...
  if ((arguments.length === 2 || arguments.length === 3) &&
    ...
    m.defineModule(
        u.Utilities.generateAnonymousModule(), arguments[0], arguments[1],
        arguments[2], null);
    return
  }
...
u.init = c,
    ...
    (m = new u.ModuleManager(
         y, u.createScriptLoader(y), p, r,
         u.Utilities.getHighPerformanceTimestamp()),
     typeof u.global.require < 'u' && typeof u.global.require != 'function' &&
